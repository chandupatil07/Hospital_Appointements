...
//   const getAvailableSlots = async () => {
//   if (!docInfo) return; // Prevent running if docInfo is not ready
//   // ...rest of your logic ---->bug in the code 
// };

   let slots = []; //Updated bug
// setDocSlots([])
...
// // ***** If you want there is no slots today then add******NO Slots option then ***
...
// add slot to array
  ...
  // Added bug in code of if statement  block to show todays present day date and day name
...
useEffect(() => {
  ...
  if (doctors && doctors.length > 0 && docId) {
    ...
    console.log("Found doctor object:", found);
    setDocInfo(found);
  }
}, [doctors, docId]);
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <p className='flex items-center gap-2 text-2xl font-medium test-gray-900'>{docInfo.name}
