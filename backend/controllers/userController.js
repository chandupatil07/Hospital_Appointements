...
const bookAppointment = async (req,res) => {
  ...
  try {
    ...
    // const {userId, docId, slotDate, slotTime} = req.body  //most recent changed
...
const listAppointment = async (req,res) => {
  ...
  try {
    ...
    // const {userId} = req.body  //Most recently changed
       const userId = req.userId 
...
const cancelAppointment = async (req, res) => {
  ...
  try {
    ...
    // const {userId, appointmentId} = req.body  //most recent changed
    const userId = req.userId
