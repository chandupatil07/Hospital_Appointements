...
//API to getdashboard data for admin panel
...
export { addDoctor,loginAdmin,allDoctors,appointmentsAdmin,appointmentCancel,adminDashboard};//changeAvailability newly added
